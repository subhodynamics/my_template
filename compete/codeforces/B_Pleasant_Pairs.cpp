...
void solve() {
    ...
    //don't traverse on i,j, instead traverse on ai, aj, cause in that case
    // for ai, aj, if we fix ai then aj will be (1, sqrt(2n));
    // max value of i+j = n + (n-1) = 2n - 1; basically < 2n
